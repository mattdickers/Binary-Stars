...
Periodogram.periodogram(lightcurve, '4987', talk=1)
...
##if phase:
##    plt.xlabel('Phase')
##    plt.savefig('lightcurves/'+fileName+'(Phase).png')
##    plt.savefig('lightcurves/'+fileName+'(Phase).pdf')
##    plt.show()
##else:
##    plt.xlabel('Julian Date')
##    plt.savefig('lightcurves/'+fileName+'(Day).png')
##    plt.savefig('lightcurves/'+fileName+'(Day).pdf')
##    plt.show()
